...
public class EnemySpawnController : MonoBehaviour {
    ...
    void SpawnEnemy()
    {
        ...
        {
            instance = Instantiate(enemies[0], spawnValues, Quaternion.Euler(0, 0, Random.Range(0, 360))) as GameObject;
        }
        else if (enemyChoice <= (enemy1Chance + enemy2Chance) && enemyChoice > enemy1Chance)
        {
            instance = Instantiate(enemies[1], spawnValues, Quaternion.Euler(0, 0, Random.Range(0, 360))) as GameObject;
        }
        else if (enemyChoice <= (enemy1Chance + enemy2Chance + enemy3Chance) && enemyChoice > (enemy1Chance + enemy2Chance))
        {
            instance = Instantiate(enemies[2], spawnValues, Quaternion.Euler(0, 0, Random.Range(0, 360))) as GameObject;
        }
        ...
        {
            instance = Instantiate(enemies[3], spawnValues, Quaternion.Euler(0, 0, Random.Range(0, 360))) as GameObject;
        }
        else if (enemyChoice > (enemy1Chance + enemy2Chance + enemy3Chance))
        {
            instance = Instantiate(enemies[4], spawnValues, Quaternion.identity) as GameObject;
        }
    }
}
